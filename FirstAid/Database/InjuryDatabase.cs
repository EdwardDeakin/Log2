...
namespace FirstAid.Database
{
    class InjuryDatabase
    {
        ...
        public InjuryDatabase()
        {
            ...
            {
                // Add data here.
                _Database.Insert(new Injury { InjuryName = "First Degree Burn", CategoryId = 1, TreatmentId = 0 });
                _Database.Insert(new Injury { InjuryName = "Second Degree Burn", CategoryId = 1, TreatmentId = 0 });
                _Database.Insert(new Injury { InjuryName = "Third Degree Burn", CategoryId = 1, TreatmentId = 0 });
                _Database.Insert(new Injury { InjuryName = "Broken Arm", CategoryId = 2, TreatmentId = 0 });
                _Database.Insert(new Injury { InjuryName = "Broken Rib", CategoryId = 2, TreatmentId = 0 });
                //_Database.Insert(new Injury { CategoryName = "Broken Bones" });
            }

            //_Database.DeleteAll<Injury>();
        }
